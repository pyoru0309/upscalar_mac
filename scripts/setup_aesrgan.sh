...
REPO_DIR="${UPSCALAR_AESRGAN_REPO:-"$ROOT/external/A-ESRGAN"}"
...
export UPSCALAR_AESRGAN_REPO="$REPO_DIR"
export UPSCALAR_AESRGAN_MODEL="$MODEL_DIR/A_ESRGAN_Multi.pth"
export UPSCALAR_AESRGAN_MULTI_MODEL="$MODEL_DIR/A_ESRGAN_Multi.pth"
export UPSCALAR_AESRGAN_SINGLE_MODEL="$MODEL_DIR/A_ESRGAN_Single.pth"
EOF
